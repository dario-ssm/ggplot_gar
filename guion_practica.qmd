...
```{r}
DT::datatable(all_teams_averages)
```
...
-   Tendencia: con la geometría `geom_smooth()`, ya sea con un argumento `method = "lm"` para una tendencia lineal (***l**inear **m**odel*) o una variable llamada *loess*.
